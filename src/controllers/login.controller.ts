...
router.post('/login', (req, res) => {
    ...
    if (user) {
        ...
        const token = jwt.sign(jwtItem, 'dfffc72c84204af3147e2998255cb8082837b8fcc2d6969965afce1bfb91b39053256a7c78e4d7b0ad2290f4740467e4e0dae87bf8fca7421acd24acc7b42edc');
        res.json({ token });
    } else {
