...
import { AirdropJob, CreateAirdropJobDto, RedeemNftDto, UpdateAirdropJobDto } from "../models/dto";
...
export class AirdropService {
    ...
    redeemNft(redeemNftDto: RedeemNftDto): AirdropJob {
        ...
        const airdropJob = this.airdropJobStore.findByRedeemCodeOrFiail(redeemCode);
        ...
        const result = this.airdropJobStore.update(airdropJob.uuid, airdropJob);
    ...
    getAirdropJobByRedeemCode(redeemCode: string): AirdropJob {
        return this.airdropJobStore.findByRedeemCodeOrFiail(redeemCode);
    }



    updateAirdropJob(redeemCode: string, updateAirdropJobDto: UpdateAirdropJobDto): AirdropJob {
